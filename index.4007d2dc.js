 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const U=function(e){let t={},n={},i={},r="";try{const s=e.split(".");t=B(g(s[0])||""),n=B(g(s[1])||""),r=s[2],i=n.d||{},delete n.d}catch(e){}return{header:t,claims:n,data:i,signature:r}},j=function(e){const t=U(e).claims;return!!t&&"object"==typeof t&&t.hasOwnProperty("iat")},W=function(e){const t=U(e).claims;return"object"==typeof t&&!0===t.admin};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Be(e,t,n=!1){const i="signIn",r=await Me(e,i,t),s=await Ae._fromIdTokenResponse(e,i,r);return n||await e._updateCurrentUser(s.user),s}async function Fe(e,t){return Be(de(e),t)}async function Ue(e,t,n){const i=de(e),r=await Pe(i,{returnSecureToken:!0,email:t,password:n}),s=await Ae._fromIdTokenResponse(i,"signIn",r);return await i._updateCurrentUser(s.user),s}function je(e,t,n){return Fe((0,i.getModularInstance)(e),Te.credential(t,n))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zt=new C(3e4,6e4);function Bt(){const e=Ze().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Ft=null;function Ut(e){return Ft=Ft||function(e){return new Promise(((t,n)=>{var i,r,s;function o(){Bt(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Bt(),n(m(e,"network-request-failed"))},timeout:zt.get()})}if(null===(r=null===(i=Ze().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=Ze().gapi)||void 0===s?void 0:s.load)){const t=ht("iframefcb");return Ze()[t]=()=>{gapi.load?o():n(m(e,"network-request-failed"))},dt(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw Ft=null,e}))}(e),Ft}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
...
//# sourceMappingURL=index.4007d2dc.js.map
